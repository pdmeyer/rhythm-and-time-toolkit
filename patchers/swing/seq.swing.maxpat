...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 58.0, 50.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 78.0, 253.0, 22.0 ],
...
,
					"text" : "pattrstorage seq.swing-presets @savemode 0",
					"varname" : "seq.swing-presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.5, 212.5, 98.0, 22.0 ],
					"text" : "seq.swing.model",
					"varname" : "m"
				}
