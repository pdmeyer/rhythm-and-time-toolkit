...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.631578557554235, 58.400390625, 274.0, 22.0 ],
...
,
					"text" : "pattrstorage seq.sequence.presets @savemode 0",
					"varname" : "seq.sequence.presets"
				}
