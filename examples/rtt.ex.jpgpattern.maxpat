...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 209.5, 229.416669416393745, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 535.0, 149.916669416393745, 165.0, 220.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.25, 311.916669416393745, 207.5, 52.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 176.499999999999943, 100.0, 39.0, 22.0 ],
									"text" : "mtof~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 176.666666666666686, 155.0, 75.0, 22.0 ],
									"text" : "lores~ 4500."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 183.0, 145.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 155.0, 117.0, 22.0 ],
...
,
					"patching_rect" : [ 98.0, 542.083334135975292, 145.499999999999943, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "bang" ],
					"patching_rect" : [ 315.0, 34.416669416393745, 302.0, 65.583330583606255 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 181.5, 45.0, 22.0 ],
									"text" : "row $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 157.5, 64.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
,
					"patching_rect" : [ 234.0, 229.416669416393745, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 224.416669416393745, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 431.0, 226.416669416393745, 220.0, 22.0 ],
					"restore" : [ "fernie.jpg" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"text" : "pattr @bindto i2p::filename @invisible 1",
					"varname" : "u312006037[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.25, 224.416669416393745, 74.5, 20.0 ],
					"text" : "drag n' drop",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 336.5, 219.416669416393745, 92.5, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.5, 196.916669416393745, 66.5, 20.0 ],
					"text" : "threshold",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.5, 173.916669416393745, 66.5, 20.0 ],
					"text" : "row",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.5, 147.916669416393745, 66.5, 20.0 ],
					"text" : "steps",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 98.0, 569.083334135975292, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 89.333333333333314, 619.083334135975292, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 119.0, 377.916669416393745, 93.0, 34.369565217391312 ],
					"range" : [ -0.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 149.916669416393745, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 177.916669416393745, 223.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 149.916669416393745, 150.0, 22.0 ],
					"varname" : "bar/bpm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 196.916669416393745, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.0, 196.916669416393745, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 431.0, 196.916669416393745, 224.0, 22.0 ],
					"restore" : [ 0.5 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"text" : "pattr @bindto i2p::threshold @invisible 1",
					"varname" : "u312006037[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 171.916669416393745, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.0, 171.916669416393745, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"restore" : [ 0.58425110578537 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
,
					"text" : "pattr @bindto i2p::row @invisible 1",
					"varname" : "u312006037[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 146.916669416393745, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.0, 146.916669416393745, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 432.5, 146.916669416393745, 222.5, 22.0 ],
					"restore" : [ 8 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"text" : "pattr @bindto i2p::steps @invisible 1",
					"varname" : "u312006037"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 288.916669416393745, 223.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 257.0, 290.916669416393745, 192.0, 18.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 234.0, 256.416669416393745, 118.0, 22.0 ],
					"text" : "rtt.xtra.img2pattern",
					"varname" : "i2p"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 226.416669416393745, 224.0, 20.0 ],
					"text" : "fernie.jpg"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 90.0, 203.833335280418396, 29.5, 22.0 ],
									"text" : "i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 90.0, 179.0, 40.0, 22.0 ],
									"text" : "* 220."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 225.0, 99.0, 22.0 ],
									"text" : "pak size 165 220"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 90.0, 155.0, 29.5, 22.0 ],
									"text" : "/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 90.0, 127.0, 59.0, 22.0 ],
									"text" : "route dim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 100.0, 73.0, 22.0 ],
									"text" : "jit.matrixinfo"
								}
...
,
					"patching_rect" : [ 535.0, 147.916669416393745, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 67.0, 272.0, 69.0 ],
					"text" : "rtt.pattern~ will play back any list of 0s and 1s you give it. There are lots of creative ways to get these lists - one is to derive them from some other rich material like an image."
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 342.5, 288.416669416393745, 527.5, 288.416669416393745, 527.5, 140.916669416393745, 544.5, 140.916669416393745 ],
					"order" : 1,
					"source" : [ "obj-1", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 342.5, 288.416669416393745, 528.0, 288.416669416393745, 528.0, 141.916669416393745, 544.5, 141.916669416393745 ],
					"order" : 0,
					"source" : [ "obj-1", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 324.5, 137.0, 635.0, 137.0, 635.0, 23.416669416393745, 607.5, 23.416669416393745 ],
					"source" : [ "obj-2666", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.5, 373.333337056602943, 551.5, 373.333337056602943 ],
					"source" : [ "obj-93", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 39.5, 458.833334275883203, 233.999999999999943, 458.833334275883203 ],
					"source" : [ "obj-93", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-30::obj-41" : [ "live.text[8]", "live.text[9]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
