...
, 			{
				"box" : 				{
					...
					"text" : "Uses externals from the  (fantastic) FluidCorpusManipulation (aka FluCoMa) to store audio in a buffer and store, in a second buffer a list of sample positions where onsets occur in the first buffer"
				}
