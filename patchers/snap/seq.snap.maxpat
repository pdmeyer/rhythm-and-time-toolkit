...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.5, 189.5, 93.0, 22.0 ],
					"text" : "seq.snap.model",
					"varname" : "m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 189.0, 46.0, 166.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 74.0, 249.0, 22.0 ],
...
,
					"text" : "pattrstorage seq.snap-presets @savemode 0",
					"varname" : "seq.snap-presets"
				}
