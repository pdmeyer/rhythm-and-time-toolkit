...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 415.045640833237599, 315.0, 83.882352941176464, 31.0 ],
									"range" : [ -0.1, 1.1 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 367.0, 315.0, 41.0, 22.0 ],
									"text" : "what~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 367.0, 192.0, 41.0, 22.0 ],
									"text" : "div $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 367.0, 162.5, 29.5, 22.0 ],
									"text" : "/ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 208.0, 162.5, 60.0, 22.0 ],
									"text" : "subdiv $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 208.0, 96.0, 70.0, 22.0 ],
									"text" : "loadmess 8"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 367.0, 223.0, 50.0, 22.0 ],
									"text" : "subdiv~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "int" ],
									"patching_rect" : [ 367.0, 275.0, 119.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 28.0, 121.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 28.0, 343.0, 121.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 165.045640833237599, 243.0, 83.882352941176464, 31.0 ],
									"range" : [ -0.1, 1.1 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 28.0, 243.0, 134.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
,
									"text" : "seq.swing~ @depth 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 91.0, 158.0, 83.882352941176464, 31.0 ],
									"range" : [ -0.1, 1.1 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 28.0, 162.5, 56.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"text" : "seq.swing~ achieves the same result as swing~, but in a different way. "
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 217.5, 156.75, 376.5, 156.75 ],
									"order" : 0,
									"source" : [ "obj-24", 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "The abstraction seq.swing (no tilde) contains the seq.swing~ object, a UI and pattr support."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 28.0, 342.0, 121.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 28.0, 311.0, 134.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "signal", "" ],
									"patching_rect" : [ 28.0, 185.0, 56.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-2::obj-1::obj-6::obj-10" : [ "live.numbox[30]", "live.numbox[2]", 0 ],
			...
			"obj-2::obj-3::obj-6::obj-2" : [ "live.button[45]", "live.button", 0 ],
