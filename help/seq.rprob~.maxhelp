...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 351.0, 202.782608695652243, 41.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 232.136001586914062, 57.599853515625 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 351.0, 177.0, 263.0, 22.0 ],
									"restore" : [ 2.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 360.5, 351.0, 20.0, 351.0, 20.0, 192.0, 48.5, 192.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 360.5, 234.782608695652243, 344.5, 234.782608695652243, 344.5, 135.782608695652243, 360.5, 135.782608695652243 ],
									"order" : 1,
									"source" : [ "obj-16", 0 ]
								}
...
,
					"patching_rect" : [ 190.0, 213.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 183.0, 261.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 24.0, 353.0, 56.0, 22.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 466.5, 173.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 352.75, 161.0, 137.0, 40.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 238.75, 348.5, 187.0, 31.0 ],
									"range" : [ -0.1, 1.1 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 24.0, 313.0, 234.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 24.0, 220.0, 200.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
,
									"text" : "seq.loop~ @steps 8 @subdivision 8"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 264.0, 313.0, 150.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 450.0, 283.0, 150.0, 22.0 ]
								}
...
,
					"patching_rect" : [ 117.0, 205.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 375.0, 213.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"name" : "seq.rprob.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/seq/patchers/rprob",
				"patcherrelativepath" : "../patchers/rprob",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
