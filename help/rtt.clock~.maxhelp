...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 172.0, 283.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 76.0, 268.5, 108.0, 25.0 ],
									"text" : "turn on audio"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 268.5, 25.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-4",
									"ignoreclick" : 1,
									"jsarguments" : [ "rtt.clock~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 204.823974609375, 57.599853515625 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 376.0, 261.0, 101.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "to use the module, create a rtt.clock patcher and give it a unique name as the first argument"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 333.5, 320.0, 29.0, 320.0, 29.0, 155.0, 48.5, 155.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 208.0, 287.0, 43.028007507324219, 20.0 ],
									"text" : "phase"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 195.0, 261.0, 56.0, 22.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 118.000000000000028, 195.0, 112.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
,
									"text" : "rtt.clock~ @bpm 40"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 267.485996246337891, 287.0, 61.028007507324219, 20.0 ],
									"text" : "hard sync"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 134.485996246337891, 287.0, 32.028007507324219, 20.0 ],
									"text" : "bpm"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 79.0, 310.0, 193.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
									}
...
,
		...
		"parameters" : 		{
			...
			"obj-2::obj-3::obj-6::obj-12" : [ "live.text[1]", "live.text[2]", 0 ],
			"obj-2::obj-3::obj-6::obj-2" : [ "live.button[2]", "live.button", 0 ],
			"obj-2::obj-3::obj-6::obj-9" : [ "live.text[7]", "live.text[2]", 0 ],
			"obj-2::obj-3::obj-93::obj-25" : [ "live.button[4]", "live.button", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
