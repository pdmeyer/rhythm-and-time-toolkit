...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 78.0, 245.0, 22.0 ],
...
,
					"text" : "pattrstorage rtt.swing-presets @savemode 0",
					"varname" : "rtt.swing-presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 11.5, 212.5, 89.0, 22.0 ],
					"text" : "rtt.swing.model",
					"varname" : "m"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-93", 0 ],
					"midpoints" : [ 67.5, 167.0, 52.5, 167.0, 52.5, 39.0, 67.5, 39.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-10" : [ "live.numbox[94]", "live.numbox[2]", 0 ],
			"obj-6::obj-2" : [ "live.button[53]", "live.button", 0 ],
			"obj-6::obj-6" : [ "live.numbox[95]", "live.numbox[2]", 0 ],
