...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 207.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 207.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 207.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.5, 207.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 308.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.5, 308.0, 30.0, 30.0 ]
				}
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.0, 74.0, 241.0, 22.0 ],
...
,
					"text" : "pattrstorage rtt.clock.presets @savemode 0",
					"varname" : "rtt.clock.presets"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.5, 268.5, 127.5, 22.0 ],
					"text" : "rtt.clock.model",
					"varname" : "m"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 110.0, 145.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-93", 0 ],
					"midpoints" : [ 67.5, 166.0, 46.5, 166.0, 46.5, 39.0, 67.5, 39.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-10" : [ "live.numbox[89]", "live.numbox[2]", 0 ],
			"obj-6::obj-12" : [ "live.text[6]", "live.text[2]", 0 ],
			"obj-6::obj-2" : [ "live.button[3]", "live.button", 0 ],
			"obj-6::obj-9" : [ "live.text[5]", "live.text[2]", 0 ],
