...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.5, 214.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.5, 298.0, 30.0, 30.0 ],
					"varname" : "phasor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.5, 298.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"autorestore" : "seq.loop.presets.xml",
					"id" : "obj-3",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 79.0, 245.0, 22.0 ],
...
,
					"text" : "pattrstorage seq.loop.presets @savemode 0",
					"varname" : "seq.loop.presets"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.5, 258.5, 107.0, 22.0 ],
					"text" : "seq.counter.model",
					"varname" : "m"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-93", 0 ],
					"midpoints" : [ 67.5, 192.0, 43.5, 192.0, 43.5, 41.0, 67.5, 41.0 ],
					"source" : [ "obj-6", 0 ]
				}
