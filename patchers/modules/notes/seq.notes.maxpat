...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.631578557554235, 58.400390625, 251.0, 22.0 ],
					"priority" : 					{
						"m::sequence/raw" : 1,
						"m::seq-length" : -1
					}
...
,
					"text" : "pattrstorage seq.notes.presets @savemode 0",
					"varname" : "seq.notes.presets"
				}
