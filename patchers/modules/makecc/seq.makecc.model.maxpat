...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 212.0, 71.0, 71.5, 22.0 ],
					"text" : "typeroute~"
				}
...
,
					"text" : "pattr controller @type char @initial 1",
					"varname" : "controller"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 205.0, 87.0, 22.0 ],
					"text" : "prepend range"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 296.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 36.0, 322.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 36.0, 181.0, 207.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "1" ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"text" : "pattr range @type symbol @initial \"1\"",
					"varname" : "range"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 367.0, 80.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 31.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 45.5, 353.0, 181.25, 353.0, 181.25, 291.0, 162.5, 291.0 ],
					"source" : [ "obj-20", 0 ]
				}
