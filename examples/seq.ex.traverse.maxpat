...
, 			{
				"box" : 				{
					"autorestore" : "seq.ex.traverse.json",
					"id" : "obj-61",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
					"text" : "pattrstorage seq.ex.traverse @savemode 2",
					"varname" : "seq.ex.traverse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 256.500000000000057, 170.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 196.391304347826093, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 213.0, 170.0, 43.0, 22.0 ],
					"text" : "%~ 16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.0, 193.0, 128.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
,
					"text" : "seq.loop~ @subdiv 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "" ],
					"patching_rect" : [ 67.0, 146.0, 238.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 222.5, 226.195652173913061, 581.5, 226.195652173913061 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
